...
set_property -dict { PACKAGE_PIN J1   IOSTANDARD LVCMOS33 } [get_ports {DHT11}]
set_property -dict { PACKAGE_PIN L2   IOSTANDARD LVCMOS33 } [get_ports {echo}]
set_property -dict { PACKAGE_PIN J2   IOSTANDARD LVCMOS33 } [get_ports {TRIG}]
...
set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS33 } [get_ports {ss_n}]

set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS33 } [get_ports {scl}]
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports {sda}]
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports {rx}]
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports {tx}]
